...
namespace WpCaptchaShield\Tests\Unit\WordPress\Forms\Registration;
...
final class RegistrationFormIntegrationTest extends TestCase
{
    ...
    public function testItEnqueuesRegistrationAssetsAndTheSharedWidget(): void
    {
        ...
        self::assertSame('wordpress_registration', $widget->action);
    ...
    public function testItPreservesExistingRegistrationErrors(): void
    {
        ...
        self::assertSame('existing_error', $result->get_error_code());
    }
    ...
    public function testItPreservesTheErrorCollectionWhenVerificationSucceeds(): void
    {
    ...
    private function integrationWithRepository(
        ...
        return new RegistrationFormIntegration(
            $repository,
