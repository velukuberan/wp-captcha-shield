...
final class RegistrationFormRegistrarTest extends TestCase
{
    ...
    public function testItRegistersRegistrationHooks(): void
    {
        ...
        (new RegistrationFormRegistrar($integration))->registerHooks();
    }

    private function integration(): RegistrationFormIntegration
    {
